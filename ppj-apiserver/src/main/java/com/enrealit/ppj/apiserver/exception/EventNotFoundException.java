...
public class EventNotFoundException extends RuntimeException implements GraphQLError {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5438639785392768984L;
	...
	public String getMessage() {
		return "L'évènement n'a pas pû être trouvé.";
	}
	...
	public Map<String, Object> getExtensions() {
		...
		map.put("errorCode", TypeException.EVENT_NOT_FOUND.toString());
